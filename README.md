...
Система состоит из следующих компонентов:
 ...
 - Go-сервис — обработка HTTP-запросов и расчёт метрик
...
Сервис является stateless, всё состояние вынесено во внешнее хранилище (Redis).
...
1. Redis
Redis разворачивается с использованием Helm-чарта:
